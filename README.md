# <a href="https://www.battleaxe.co/"><img src="https://avatars2.githubusercontent.com/u/60149336?s=200&v=4" width="40" height="40"/></a> brutalism-api

| [Library](#library) | [Getting Started](#getting-started) | [Features](#features) | [Commands](#commands) | [Contexts](#contexts) | [Use in Browser](#use-in-browser) | [Common Errors](#common-errors) | 
| ----------------------------- | :---------------------------: | :---------------------------------: | :---------------------: | :-------------------: | :-------------------: | :-------------------: |
...
## [See the live web demo of this panel here](https://brutalism.netlify.app/#/)

## Library

#### 🔥 Check out Battleaxe's [brutalism component library here](https://github.com/battleaxedotco/brutalism) 🔥 
